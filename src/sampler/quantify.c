...
void myCvReleaseQuantifiedImage(MyQuantifiedImage** q) {
    if (*q != NULL) {
...
IplImage* myQuantifyGetImage(MyQuantifiedImage* quant) {
    return quant->qImg;
}

CvMat* myQuantifyGetLabel(MyQuantifiedImage* quant) {
    return quant->labelMat;
}

CvScalar* myQuantifyGetColorTable(MyQuantifiedImage* quant) {
    return quant->colorTable;
}

int myQuantifyGetColorTableSize(MyQuantifiedImage* quant) {
